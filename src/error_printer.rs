...
impl AnreError {
    pub fn with_source(&self, source_text: &str) -> String {
        ...
        match self {
            AnreError::Message(msg) => msg.to_owned(),
            AnreError::SyntaxIncorrect(msg) => msg.to_owned(),
            AnreError::UnexpectedEndOfDocument(msg) => {
            ...
            AnreError::MessageWithPosition(msg, position) => {
                let title = format!(
            ...
            AnreError::MessageWithRange(msg, range) => {
                let title = format!(
                    "Error at line: {}, column: {}",
                    range.start.line + 1,
...
#[cfg(test)]
mod tests {
    use crate::{error::AnreError, position::Position, range::Range};
    ...
    fn test_error_with_source_and_message() {
        ...
        assert_eq!(
            AnreError::SyntaxIncorrect(msg.to_owned()).with_source(source1),
            msg
        );
        assert_eq!(
            AnreError::SyntaxIncorrect(msg.to_owned()).with_source(source2),
            msg
        );
    }
...
|                                            ^___ abcde"#
    ...
    fn test_error_with_source_and_position() {
        ...
        assert_eq!(
            AnreError::MessageWithPosition(msg.to_owned(), Position::new(0, 11, 13))
                .with_source(source1),
...
| ^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithPosition(msg.to_owned(), Position::new(2, 11, 13))
                .with_source(source1),
            r#"Error at line: 12, column: 14
| 0123456789
|   ^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithPosition(msg.to_owned(), Position::new(15, 11, 13))
                .with_source(source2),
            r#"Error at line: 12, column: 14
| ...b12345678_c12345678_d12345678_e123456789
|         ^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithPosition(msg.to_owned(), Position::new(5, 11, 13))
                .with_source(source1),
            r#"Error at line: 12, column: 14
| 0123456789
|      ^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithPosition(msg.to_owned(), Position::new(25, 11, 13))
                .with_source(source2),
            r#"Error at line: 12, column: 14
| ...b12345678_c12345678_d12345678_e123456789
|                   ^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithPosition(msg.to_owned(), Position::new(8, 11, 13))
                .with_source(source1),
            r#"Error at line: 12, column: 14
| 0123456789
|         ^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithPosition(msg.to_owned(), Position::new(45, 11, 13))
                .with_source(source2),
            r#"Error at line: 12, column: 14
| ...b12345678_c12345678_d12345678_e123456789
|                                       ^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithPosition(msg.to_owned(), Position::new(10, 11, 13))
                .with_source(source1),
            r#"Error at line: 12, column: 14
| 0123456789
|           ^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithPosition(msg.to_owned(), Position::new(50, 11, 13))
                .with_source(source2),
            r#"Error at line: 12, column: 14
| ...b12345678_c12345678_d12345678_e123456789
|                                            ^___ abcde"#
    ...
    fn test_error_with_source_and_range() {
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(0, 17, 19, 4))
                .with_source(source1),
...
| ^^^^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(0, 17, 19, 8))
                .with_source(source2),
            r#"Error at line: 18, column: 20
| 012345678_b12345678_c12345678_d12345678_...
| ^^^^^^^^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(2, 17, 19, 4))
                .with_source(source1),
            r#"Error at line: 18, column: 20
| 0123456789
|   ^^^^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(15, 17, 19, 8))
                .with_source(source2),
            r#"Error at line: 18, column: 20
| ...b12345678_c12345678_d12345678_e123456789
|         ^^^^^^^^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(5, 17, 19, 4))
                .with_source(source1),
            r#"Error at line: 18, column: 20
| 0123456789
|      ^^^^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(25, 17, 19, 8))
                .with_source(source2),
            r#"Error at line: 18, column: 20
| ...b12345678_c12345678_d12345678_e123456789
|                   ^^^^^^^^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(8, 17, 19, 4))
                .with_source(source1),
            r#"Error at line: 18, column: 20
| 0123456789
|         ^^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(45, 17, 19, 8))
                .with_source(source2),
            r#"Error at line: 18, column: 20
| ...b12345678_c12345678_d12345678_e123456789
|                                       ^^^^^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(10, 17, 19, 4))
                .with_source(source1),
            r#"Error at line: 18, column: 20
| 0123456789
|           ^___ abcde"#
        ...
        assert_eq!(
            AnreError::MessageWithRange(msg.to_owned(), Range::from_detail(50, 17, 19, 8))
                .with_source(source2),
            r#"Error at line: 18, column: 20
| ...b12345678_c12345678_d12345678_e123456789
|                                            ^___ abcde"#
